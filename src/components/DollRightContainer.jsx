...
const DollRightContainer = ({isUtils = false, setStats = null, handleRightItems = null, unsetRight = null}) => {
    ...
    return (
        <div className="doll-container" style={{border: isUtils ? 'none' : ''}}>
            <div className="container--indicator" ref={dollContainerRef}></div>
            {
                ...
                </header> : <div className="util-dolls__doll-header">
                    <div className="util-dolls__header-buttons">
                        <Button className="button secondary" onClick={handleRightItems}>{buttons.items}</Button>
                        <Button className="button secondary" onClick={unsetRight}>{buttons.dolls}</Button>
            ...
            <div className="doll-container__content">
                <div className="doll-container__levels">
                    {
                        dollDetailsLoading ? (<Box className="loader">
                            ...
                            {
                                !isUtils && <Button className="button secondary" onClick={handleClick}>
                                    {buttons.save}
                                </Button>
                            }
                        </div>)
                    ...
                    <div className="doll-container__levels-container">
                        <div className="doll-container__level">
                            <div className="doll-container__level-img-lvl">
                                ...
                                <b>
                                    <StatRight stat={titleLevel} itemStat={0} statName='title'/>
                                </b>
                            </div>
                        ...
                        <div className="doll-container__level">
                            <div className="doll-container__level-img-lvl">
                                ...
                                <b>
                                    <StatRight stat={degreeLevel} itemStat={0} statName='degree'/>
                                </b>
                            </div>
                ...
                <div className="doll-container__doll"
                    ...
                    <div className="doll-column">
                        <div id="right-doll-slot__crystalPD"
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`} className="item-before"
                                 alt=""/>
                            {crystalPD && (<ItemRight itemClassName="doll-item" item={crystalPD} dollItem='true'/>)}
                        </div>
                        <div id="right-doll-slot__crystalMD"
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`} className="item-before"
                                 alt=""/>
                            {crystalMD && (<ItemRight itemClassName="doll-item" item={crystalMD} dollItem='true'/>)}
                        </div>
                        <div id="right-doll-slot__crystalPA"
                             title={buttons.crystalPA}
                             className={crystalPA ? "slot special contains-item" : "slot slot-clickable special"}
                             onClick={() => getItems('crystals')}>
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`} className="item-before"
                                 alt=""/>
                            {crystalPA && (<ItemRight itemClassName="doll-item" item={crystalPA} dollItem='true'/>)}
                        </div>
                        <div id="right-doll-slot__crystalMA"
                             title={buttons.crystalMA}
                             className={crystalMA ? "slot special contains-item" : "slot slot-clickable special"}
                             onClick={() => getItems('crystals')}>
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`} className="item-before"
                                 alt=""/>
                            {crystalMA && (<ItemRight itemClassName="doll-item" item={crystalMA} dollItem='true'/>)}
                        </div>
                    </div>
                    <div className="doll-column">
                        <div id="right-doll-slot__helmet"
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-helmet`} className="item-before"
                                 alt=""/>
                            {helmet && (<ItemRight prefix={helmet.prefix} itemClassName="doll-item" item={helmet} dollItem='true'/>)}
                        </div>
                        <div  id="right-doll-slot__amulet"
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-amulet`} className="item-before"
                                 alt=""/>
                            {amulet && (<ItemRight prefix={amulet.prefix} itemClassName="doll-item" item={amulet} dollItem='true'/>)}
                        </div>
                        <div id="right-doll-slot__shield"
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-shield`} className="item-before"
                                 alt=""/>
                            {shield && (<ItemRight prefix={shield.prefix} itemClassName="doll-item" item={shield} dollItem='true'/>)}
                        </div>
                        <div id="right-doll-slot__bracer1"
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-bracers`} className="item-before"
                                 alt=""/>
                            {bracelet1 && (<ItemRight prefix={bracelet1.prefix} itemClassName="doll-item" item={bracelet1} dollItem='true'/>)}
                        </div>
                        <div id="right-doll-slot__ring1"
                             title={buttons.rings}
                            ...
                            {ring1 && (<ItemRight prefix={ring1.prefix} itemClassName="doll-item" item={ring1} dollItem='true' isRing={true}/>)}
                        </div>
                        <div id="right-doll-slot__ring2"
                             title={buttons.rings}
                             className={ring2 ? "slot ring contains-item" : "slot slot-clickable ring"}>
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-rings`} className="item-before"
                                 alt="" onClick={() => getItems('ring-title')}/>
                            {ring2 && (<ItemRight prefix={ring2.prefix} itemClassName="doll-item" item={ring2} dollItem='true' isRing={true}/>)}
                        </div>
                    </div>
                    <div className="doll-column">
                        <div id="right-doll-slot__cuirass"
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-armor`} className="item-before"
                                 alt=""/>
                            {jacket && (<ItemRight prefix={jacket.prefix} itemClassName="doll-item" item={jacket} dollItem='true'/>)}
                        </div>
                        <div id="right-doll-slot__belt"
                             title={buttons.belts}
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-belt`} className="item-before"
                                 alt=""/>
                            {belt && (<ItemRight prefix={belt.prefix} itemClassName="doll-item" item={belt} dollItem='true'/>)}
                        </div>
                        <div id="right-doll-slot__pants"
                             title={buttons.pants}
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-pants`} className="item-before"
                                 alt=""/>
                            {pants && (<ItemRight prefix={pants.prefix} itemClassName="doll-item" item={pants} dollItem='true'/>)}
                        </div>
                        <div id="right-doll-slot__boots"
                             title={buttons.boots}
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-shoes`} className="item-before"
                                 alt=""/>
                            {boots && (<ItemRight prefix={boots.prefix} itemClassName="doll-item" item={boots} dollItem='true'/>)}
                        </div>
                    </div>
                    <div className="doll-column">
                        <div id="right-doll-slot__profession"
                             title={buttons.professions}
                             className={profession ? "slot special contains-item" : "slot special"}>
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`} className="item-before"
                                 alt=""/>
                            {profession && (<ItemRight itemClassName="doll-item" item={profession} dollItem='true'/>)}
                        </div>
                        <div id="right-doll-slot__gloves"
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-gloves`} className="item-before"
                                 alt=""/>
                            {gloves && (<ItemRight prefix={gloves.prefix} itemClassName="doll-item" item={gloves} dollItem='true'/>)}
                        </div>
                        <div id="right-doll-slot__bracer2"
                             title={buttons.bracers}
                             className={bracelet2 ? "slot bracelet contains-item" : "slot slot-clickable bracelet"}
                             onClick={() => getItems('bracelet')}>
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-bracers`} className="item-before"
                                 alt=""/>
                            {bracelet2 && (<ItemRight prefix={bracelet2.prefix} itemClassName="doll-item" item={bracelet2} dollItem='true'/>)}
                        </div>
                        <div id="right-doll-slot__ring3"
                             title={buttons.rings}
                             className={ring3 ? "slot ring contains-item" : "slot slot-clickable ring"}
                             onClick={() => getItems('ring-title')}>
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-rings`} className="item-before"
                                 alt=""/>
                            {ring3 && (<ItemRight prefix={ring3.prefix} itemClassName="doll-item" item={ring3} dollItem='true' isRing={true}/>)}
                        </div>
                        <div id="right-doll-slot__ring4"
                             title={buttons.rings}
                             className={ring4 ? "slot ring contains-item" : "slot slot-clickable ring"}
                             onClick={() => getItems('ring-title')}>
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-rings`} className="item-before"
                                 alt=""/>
                            {ring4 && (<ItemRight prefix={ring4.prefix} itemClassName="doll-item" item={ring4} dollItem='true' isRing={true}/>)}
                        </div>
                    </div>
                    <div className="doll-column">
                        <div id="right-doll-slot__weapon"
                            ...
                            {weapon && (<ItemRight prefix={weapon.prefix} itemClassName="doll-item" item={weapon} dollItem='true'/>)}
                        </div>
                        <div style={{display: 'flex', marginBottom: 48}}>
                            <div className="doll-column">
                                <div id="right-doll-slot__buff10"
                                     title={buttons.magic}
                                     className={buff10 ? "slot special contains-item" : "slot special"}>
                                    <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`}
                                         className="item-before" alt=""/>
                                    {buff10 && (
                                        <ItemRight itemClassName="doll-item" item={buff10} dollItem='true' buff='true'/>)}
                                </div>
                                <div  id="right-doll-slot__buff8"
                                      title={buttons.magic}
                                      className={buff8 ? "slot special contains-item" : "slot special"}>
                                    <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`}
                                         className="item-before" alt=""/>
                                    {buff8 && (
                                        <ItemRight itemClassName="doll-item" item={buff8} dollItem='true' buff='true'/>)}
                                </div>
                                <div id="right-doll-slot__buff6"
                                     title={buttons.magic}
                                     className={buff6 ? "slot special contains-item" : "slot special"}>
                                    <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`}
                                         className="item-before" alt=""/>
                                    {buff6 && (
                                        <ItemRight itemClassName="doll-item" item={buff6} dollItem='true' buff='true'/>)}
                                </div>
                                <div id="right-doll-slot__buff4"
                                     title={buttons.magic}
                                     className={buff4 ? "slot special contains-item" : "slot special"}>
                                    <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`}
                                         className="item-before" alt=""/>
                                    {buff4 && (
                                        <ItemRight itemClassName="doll-item" item={buff4} dollItem='true' buff='true'/>)}
                                </div>
                                <div id="right-doll-slot__buff2"
                                     title={buttons.magic}
                                     className={buff2 ? "slot special contains-item" : "slot special"}>
                                    <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`}
                                         className="item-before" alt=""/>
                                    {buff2 && (
                                        <ItemRight itemClassName="doll-item" item={buff2} dollItem='true' buff='true'/>)}
                                </div>
                            </div>
                            <div className="doll-column">
                                <div id="right-doll-slot__buff9"
                                     title={buttons.magic}
                                     className={buff9 ? "slot special contains-item" : "slot special"}>
                                    <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`}
                                         className="item-before" alt=""/>
                                    {buff9 && (
                                        <ItemRight itemClassName="doll-item" item={buff9} dollItem='true' buff='true'/>)}
                                </div>
                                <div id="right-doll-slot__buff7"
                                     title={buttons.magic}
                                     className={buff7 ? "slot special contains-item" : "slot special"}>
                                    <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`}
                                         className="item-before" alt=""/>
                                    {buff7 && (
                                        <ItemRight itemClassName="doll-item" item={buff7} dollItem='true' buff='true'/>)}
                                </div>
                                <div id="right-doll-slot__buff5"
                                     title={buttons.magic}
                                     className={buff5 ? "slot special contains-item" : "slot special"}>
                                    <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`}
                                         className="item-before" alt=""/>
                                    {buff5 && (
                                        <ItemRight itemClassName="doll-item" item={buff5} dollItem='true' buff='true'/>)}
                                </div>
                                <div id="right-doll-slot__buff3"
                                     title={buttons.magic}
                                     className={buff3 ? "slot special contains-item" : "slot special"}>
                                    <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`}
                                         className="item-before" alt=""/>
                                    {buff3 && (
                                        <ItemRight itemClassName="doll-item" item={buff3} dollItem='true' buff='true'/>)}
                                </div>
                                <div id="right-doll-slot__buff1"
                                     title={buttons.magic}
                                     className={buff1 ? "slot special contains-item" : "slot special"}>
                                    <img src={`${process.env.REACT_APP_BACKEND_URL}/image/item-special`}
                                         className="item-before" alt=""/>
                                    {buff1 && (
                                        <ItemRight itemClassName="doll-item" item={buff1} dollItem='true' buff='true'/>)}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="doll-container__extra-slots">
                        <div className={slot1 ? "slot blank contains-item" : "slot blank"} id="slot1" onDrop={drop}
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/block-brown`} className="item-before"
                                 alt=""/>
                            {slot1 && (
                                <ItemRight prefix={slot1.prefix} item={slot1} dollItem='true' slotItem='true' isRing={checkIfRing(slot1)}/>)}
                        </div>
                        <div className={slot2 ? "slot blank contains-item" : "slot blank"} id="slot2" onDrop={drop}
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/block-brown`} className="item-before"
                                 alt=""/>
                            {slot2 && (
                                <ItemRight prefix={slot2.prefix} item={slot2} dollItem='true' slotItem='true' isRing={checkIfRing(slot2)}/>)}
                        </div>
                        <div className={slot3 ? "slot blank contains-item" : "slot blank"} id="slot3" onDrop={drop}
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/block-brown`} className="item-before"
                                 alt=""/>
                            {slot3 && (
                                <ItemRight prefix={slot3.prefix} item={slot3} dollItem='true' slotItem='true' isRing={checkIfRing(slot3)}/>)}
                        </div>
                        <div className={slot4 ? "slot blank contains-item" : "slot blank"} id="slot4" onDrop={drop}
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/block-brown`} className="item-before"
                                 alt=""/>
                            {slot4 && (
                                <ItemRight prefix={slot4.prefix} item={slot4} dollItem='true' slotItem='true' isRing={checkIfRing(slot4)}/>)}
                        </div>
                        <div className={slot5 ? "slot blank contains-item" : "slot blank"} id="slot5" onDrop={drop}
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/block-brown`} className="item-before"
                                 alt=""/>
                            {slot5 && (
                                <ItemRight prefix={slot5.prefix} item={slot5} dollItem='true' slotItem='true' isRing={checkIfRing(slot5)}/>)}
                        </div>
                        <div className={slot6 ? "slot blank contains-item" : "slot blank"} id="slot6" onDrop={drop}
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/block-brown`} className="item-before"
                                 alt=""/>
                            {slot6 && (
                                <ItemRight prefix={slot6.prefix} item={slot6} dollItem='true' slotItem='true' isRing={checkIfRing(slot6)}/>)}
                        </div>
                        <div className={slot7 ? "slot blank contains-item" : "slot blank"} id="slot7" onDrop={drop}
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/block-brown`} className="item-before"
                                 alt=""/>
                            {slot7 && (
                                <ItemRight prefix={slot7.prefix} item={slot7} dollItem='true' slotItem='true' isRing={checkIfRing(slot7)}/>)}
                        </div>
                        <div className={slot8 ? "slot blank contains-item" : "slot blank"} id="slot8" onDrop={drop}
                            ...
                            <img src={`${process.env.REACT_APP_BACKEND_URL}/image/block-brown`} className="item-before"
                                 alt=""/>
                            {slot8 && (
                                <ItemRight prefix={slot8.prefix} item={slot8} dollItem='true' slotItem='true' isRing={checkIfRing(slot8)}/>
                            )}
                        </div>
                    </div>
                </div>
                    ...
                    <div className="doll-container__doll-set-stats">
                        <div className="column">
                            <div className="row">
                                ...
                                <StatRight statsAvailable={title} stat={strength} itemStat={strengthStats}
                                      reqStat={reqStrength}
                                      statName='strength'/>
                                <button className="up"
                            ...
                            <div className="row">
                                ...
                                <button className="down"
                                        ...
                                        onClick={handleDecrease}/>
                                <StatRight statsAvailable={title} stat={dexterity} itemStat={dexterityStats}
                            ...
                            <div className="row">
                                ...
                                <button className="down"
                                        ...
                                        onClick={handleDecrease}/>
                                <StatRight statsAvailable={title} stat={accuracy} itemStat={accuracyStats}
                                      reqStat={reqAccuracy}
                                      statName='accuracy'/>
                                <button className="up"
                                        style={{background: `transparent url(${process.env.REACT_APP_BACKEND_URL}/image/ctrls) -0px center no-repeat`}}
                            ...
                            <div className="row">
                                ...
                                <button className="down"
                                        ...
                                        onClick={handleDecrease}/>
                                <StatRight statsAvailable={title} stat={endurance} itemStat={enduranceStats}
                        ...
                        <div className="column">
                            <div className="row">
                                ...
                                <StatRight statsAvailable={degree} stat={earth} itemStat={earthStats} reqStat={reqEarth}
                                      statName='earth'/>
                                <button className="up"
                                        style={{background: `transparent url(${process.env.REACT_APP_BACKEND_URL}/image/ctrls) -0px center no-repeat`}}
                            ...
                            <div className="row">
                                ...
                                <StatRight statsAvailable={degree} stat={air} itemStat={airStats} reqStat={reqAir}
                                      statName='air'/>
                                <button className="up"
                                        style={{background: `transparent url(${process.env.REACT_APP_BACKEND_URL}/image/ctrls) -0px center no-repeat`}}
                            ...
                            <div className="row">
                                ...
                                <StatRight statsAvailable={degree} stat={water} itemStat={waterStats} reqStat={reqWater}
                                      statName='water'/>
                                <button className="up"
                                        style={{background: `transparent url(${process.env.REACT_APP_BACKEND_URL}/image/ctrls) -0px center no-repeat`}}
                            ...
                            <div className="row">
                                ...
                                <StatRight statsAvailable={degree} stat={fire} itemStat={fireStats} reqStat={reqFire}
                                      statName='fire'/>
                                <button className="up"
                                        style={{background: `transparent url(${process.env.REACT_APP_BACKEND_URL}/image/ctrls) -0px center no-repeat`}}
...
export default DollRightContainer;