            ...
            <div>
                <div style={{
                    ...
                    {!isEdit ? (<div className="castle" onClick={handleClick}>
                        ...
                        <span style={{width: 100}}>{castle.fillingLvl}</span>
                        <span style={{width: 100, backgroundColor: statusBgr}}>&nbsp;</span>
                        <span style={{width: 100, overflow: 'hidden'}}>{currentClan?.name}</span>
                        <span style={{width: 150, overflow: 'hidden'}}>{castle.commentary}</span>
                        <span style={{width: 100, overflow: 'hidden'}}>{lastUpdateUsername?.nickname}</span>
